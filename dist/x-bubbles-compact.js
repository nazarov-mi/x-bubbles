...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (event) {
	    var nodeEditor = event.currentTarget;
	    var code = events.keyCode(event);
	    var inputCharIsSpace = events.inputCharIsSpace(event);
	    var isPrintableChar = event.key ? event.key.length === 1 : (code > 47 || code === KEY.Space || inputCharIsSpace || code === KEY.Backspace) && code !== KEY.Cmd;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (event) {
	    ...
	    if (code === KEY.Enter) {
	        ...
	        var inputChar = utils.getLastChar(event.target);
